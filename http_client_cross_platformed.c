/*
    ...
    Simple cross-platformed HTTP client
...
//this function is used for indicating
//the hostname, port number, and document path from a given URL
...
//this function is used to format and send the HTTP request
...
//defining a character buffer in which to store the HTTP request
